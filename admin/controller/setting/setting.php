...
class Setting extends \Opencart\System\Engine\Controller {
	public function index(): void {
		...
		$data['config_maintenance_html']  = html_entity_decode($this->config->get('config_maintenance_html'), ENT_QUOTES, "UTF-8");
		...
		//Social Media
		$data['config_whatsapp_order'] 		= $this->config->get('config_whatsapp_order');
		$data['config_whatsapp_phone'] 		= $this->config->get('config_whatsapp_phone');
		$data['config_whatsapp_text'] 		= $this->config->get('config_whatsapp_text');
		$data['config_instagram_username'] 	= $this->config->get('config_instagram_username');
		$data['config_twitter_username'] 	= $this->config->get('config_twitter_username');
		$data['config_facebook_username'] 	= $this->config->get('config_facebook_username');
		$data['config_tiktok_username'] 	= $this->config->get('config_tiktok_username');
		$data['config_linkedin_username'] 	= $this->config->get('config_linkedin_username');
		$data['config_pinterest_username'] 	= $this->config->get('config_pinterest_username');
		$data['config_youtube_username'] 	= $this->config->get('config_youtube_username');

		//Integration

		$data['config_google_analytics']  = $this->config->get('config_google_analytics');
		$data['config_google_tag_manager']  = $this->config->get('config_google_tag_manager');
		$data['config_facebook_pixel']  = $this->config->get('config_facebook_pixel');
		$data['config_yandex_metrica']  = $this->config->get('config_yandex_metrica');
