...
class Header extends \Opencart\System\Engine\Controller {
	public function index(): string {
		...
		$data['google_tag_manager']  = $this->config->get('config_google_tag_manager');
		$data['facebook_pixel']  = $this->config->get('config_facebook_pixel');
		$data['yandex_metrica']  = $this->config->get('config_yandex_metrica');
