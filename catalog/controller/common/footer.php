...
class Footer extends \Opencart\System\Engine\Controller {
	public function index(): string {
		...
		$data['instagram'] 		= $this->config->get('config_instagram_username');
		$data['facebook'] 		= $this->config->get('config_facebook_username');
		$data['twitter']		= $this->config->get('config_twitter_username');
		$data['tiktok'] 		= $this->config->get('config_tiktok_username');
		$data['youtube'] 		= $this->config->get('config_youtube_username');
		$data['linkedin'] 		= $this->config->get('config_linkedin_username');
		$data['pinterest'] 		= $this->config->get('config_pinterest_username');
		//////
